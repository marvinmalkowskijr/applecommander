 ...
 * <p>
 * HGR bit values ignore the high bit, as that switches the "palette", and for black and white mode,
...
public class GraphicsFileFilter implements FileFilter {
	...
	/**
	 * Indicates if this is configured for hires black and white mode.
	 */
	...
	/**
	 * Indicates if this is configured for double hires black and white mode.
	 */
